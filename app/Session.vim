...
badd +0 controllers/survey_controller.rb
badd +0 views/survey/edit.html.erb
...
silent! normal! zE
let s:l = 93 - ((0 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
93
normal! 012l
tabedit controllers/question_controller.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((15 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
